...
public class ShopDataScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.Log("{NUM: " + sd.item[i].item_num + "  NAME: " + sd.item[i].item_name + "  COST: " + sd.item[i].item_cost + "  OWN: " + sd.item[i].own + "}");
        }
    }
    ...
    public void BuyItem(int num)
    {
        ...
        //확인용 출력
        Debug.Log("{NUM: " + sd.item[num].item_num + "  NAME: " + sd.item[num].item_name + "  COST: " + sd.item[num].item_cost + "  OWN: " + sd.item[num].own + "}");
