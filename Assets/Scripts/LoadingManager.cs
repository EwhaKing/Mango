...
public class LoadingManager : MonoBehaviour
{
    ...
    {
        TeaDataScript.teaDex.item[0] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 0, \"tea_type\": 0, \"tea_name\": \"형아를 위한 차\", \"tea_description\" : \"먹자마자 나앗다는 전설의 마법차. 어마어마하다는 소문이~\", \"tea_recipe\": [{\"ingredient_num\": 0,\"ingredient_amout\": 12}],\"own\": false, \"is_read\": false}");
        TeaDataScript.teaDex.item[1] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 1, \"tea_type\": 2,\"tea_name\": \"눈에서 꿀이 뚝뚝\", \"tea_description\" : \"눈에서 꿀이 뚝뚝 내 눈엔 눈물이 뚝뚝...?ㅎ\", \"tea_recipe\": [{\"ingredient_num\": 13,\"ingredient_amout\": 12}],\"own\": false, \"is_read\": false}");
        TeaDataScript.teaDex.item[2] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 2, \"tea_type\": 1,\"tea_name\": \"코코파인 플리쉬\",\"tea_description\" : \"무더운 한여름에 생각나는 달콤짜릿한 그 맛! 코코넨네한 아기도 못참는다구~\",\"tea_recipe\": [{\"ingredient_num\": 5,\"ingredient_amout\": 6}, {\"ingredient_num\": 8,\"ingredient_amout\": 6}],\"own\": false, \"is_read\": false}");
        TeaDataScript.teaDex.item[3] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 3, \"tea_type\": 1,\"tea_name\": \"딸바보 주스\",\"tea_description\" : \"당신 혹시 이 주스를 매일 사가지 않습니까..? 당신은 이미 딸바보입니다..\",\"tea_recipe\": [{\"ingredient_num\": 2,\"ingredient_amout\": 3}, {\"ingredient_num\": 3,\"ingredient_amout\": 3}, {\"ingredient_num\": 15,\"ingredient_amout\": 6}],\"own\": false, \"is_read\": false}");
        ...
        TeaDataScript.teaDex.item[5] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 5, \"tea_type\": 0,\"tea_name\": \"레몬 디베트\",\"tea_description\" : \"신맛 쓴맛 단맛 세가지맛을 동시에 즐길 수 있는 삼미자차\",\"tea_recipe\": [{\"ingredient_num\": 0,\"ingredient_amout\": 5}, {\"ingredient_num\": 12,\"ingredient_amout\": 4}, {\"ingredient_num\": 13,\"ingredient_amout\": 3}],\"own\": false, \"is_read\": false}");
        TeaDataScript.teaDex.item[6] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 6, \"tea_type\": 1,\"tea_name\": \"레몬아... 나 자몽다...\",\"tea_description\" : \"신맛 쓴맛 단맛 세가지맛을 동시에 즐길 수 있는 삼미자차\",\"tea_recipe\": [{\"ingredient_num\": 0,\"ingredient_amout\": 3}, {\"ingredient_num\": 1,\"ingredient_amout\": 3}, {\"ingredient_num\": 3,\"ingredient_amout\": 6}],\"own\": false, \"is_read\": false}");
        TeaDataScript.teaDex.item[7] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 7, \"tea_type\": 1,\"tea_name\": \"올 때 메론라떼\",\"tea_description\" : \"형아! 올때 메론라떼~~~\",\"tea_recipe\": [{\"ingredient_num\": 9,\"ingredient_amout\": 6}, {\"ingredient_num\": 15,\"ingredient_amout\": 8}],\"own\": false, \"is_read\": false}");
        TeaDataScript.teaDex.item[8] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 8, \"tea_type\": 0,\"tea_name\": \"궁금해 허니~\",\"tea_description\" : \"자니? 자는구나... 뭐해?\",\"tea_recipe\": [{\"ingredient_num\": 10,\"ingredient_amout\": 7}, {\"ingredient_num\": 13,\"ingredient_amout\": 7}],\"own\": false, \"is_read\": false}");
        TeaDataScript.teaDex.item[9] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 9, \"tea_type\": 1,\"tea_name\": \"민트 폴라디츠\",\"tea_description\" : \"근본라떼입니다. 반박 안받음.\",\"tea_recipe\": [{\"ingredient_num\": 11,\"ingredient_amout\": 3}, {\"ingredient_num\": 14,\"ingredient_amout\": 4}, {\"ingredient_num\": 15,\"ingredient_amout\": 7}],\"own\": false, \"is_read\": false}");
        ...
        TeaDataScript.teaDex.item[11] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 11, \"tea_type\": 0,\"tea_name\": \"디벳 민트티\",\"tea_description\" : \"근본 + 근본 = 근본\",\"tea_recipe\": [{\"ingredient_num\": 11,\"ingredient_amout\": 7}, {\"ingredient_num\": 12,\"ingredient_amout\": 7}],\"own\": false, \"is_read\": false}");
        TeaDataScript.teaDex.item[12] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 12, \"tea_type\": 1,\"tea_name\": \"신호등 주스\",\"tea_description\" : \"삐빅- 딸기불입니다. 드시고가세요.\",\"tea_recipe\": [{\"ingredient_num\": 2,\"ingredient_amout\": 4}, {\"ingredient_num\": 3,\"ingredient_amout\": 4}, {\"ingredient_num\": 7,\"ingredient_amout\": 6}],\"own\": false, \"is_read\": false}");
        ...
        TeaDataScript.teaDex.item[14] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 14, \"tea_type\": 2,\"tea_name\": \"쑥쑥라떼\",\"tea_description\" : \"우유를 먹어야 쑥쑥 자라지~ 거기에 쑥을 더한\",\"tea_recipe\": [{\"ingredient_num\": 15,\"ingredient_amout\": 10}, {\"ingredient_num\": 16,\"ingredient_amout\": 6}],\"own\": false, \"is_read\": false}");

        TeaDataScript.teaDex.item[15] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 15, \"tea_type\": 2,\"tea_name\": \"감기 뚝 마늘차\",\"tea_description\" : \"뚝! 이거 먹으면 감기 뚝! 감기 안나으면 계속 먹어야할걸? ^^\",\"tea_recipe\": [{\"ingredient_num\": 13,\"ingredient_amout\": 10}, {\"ingredient_num\": 17,\"ingredient_amout\": 6}],\"own\": false, \"is_read\": false}");
