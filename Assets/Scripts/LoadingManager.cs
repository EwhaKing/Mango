...
public class LoadingManager : MonoBehaviour
{
    ...
    {
        TeaDataScript.teaDex.item[0] = JsonUtility.FromJson<TeaData>("{\"tea_num\": 0, \"tea_type\": 0, \"tea_name\": \"형아를 위한 차\", \"tea_description\" : \"먹자마자 나앗다는 전설의 마법차.<br>어마어마하다는 소문이~\", \"tea_recipe\": [{\"ingredient_num\": 0,\"ingredient_amout\": 12}],\"own\": false, \"is_read\": false}");
